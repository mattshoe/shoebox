...
interface MultiSourceLiveRepository<TParams: Any, TData: Any>: Closeable {
    fun stream(params: TParams, forceFetch: Boolean): Flow<io.github.mattshoe.shoebox.data.DataResult<TData>>
    fun latestValue(params: TParams): io.github.mattshoe.shoebox.data.DataResult<TData>?
